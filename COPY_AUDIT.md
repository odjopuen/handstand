...
| 2026-04-18 | Getting-Started myth #4 reframed: "It's a gentle yoga-style class / you'll leave exhausted" → "I'll be too exhausted to keep up / medium intensity, you set the effort, not the clock". Swaps yoga-negation framing for a beginner-fear the workshop actually has to answer (intensity), and softens "you'll leave exhausted" which was reading as a threat, not a selling point. | #2 |
| 2026-04-18 | `src/data/classes.ts` workshop short + full description rewritten. Removed "nothing's left in the tank", "we want you leaving exhausted", and "This is a workout, not a yoga class. Bring it." Replaced with transferable-strength framing and "Every minute has a purpose. Come train." Aligns with the new "focused approach" voice. | #2 |
